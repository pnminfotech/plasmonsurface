        ...
        <div class="container-fluid bg-primary py-5 bg-header" >
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Plasma - Nitrocarburising</h1>
                    <a href="" class="h5 text-white">Home</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Plasma - Nitrocarburising</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-12 ">
                    <div class="section-title position-relative pb-3  text-center">
                        ...
                        <h5 class="fw-bold text-warning text-uppercase">About Plasma - Nitrocarburising</h5>
                            <h1 class="mb-0">Plasma - Nitrocarburising</h1>
                    ...
                    <!-- <div class="col-lg-5" style="min-height: 500px;">
                        <div class="position-relative h-100">
                            <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.9s" src="img/Services/pcnb.jpg" style="object-fit: cover;">
                        </div>
                    </div>  -->
